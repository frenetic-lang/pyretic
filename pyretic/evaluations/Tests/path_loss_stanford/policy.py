...
class PathPacketLossStats:
    ...
    def query(self, **kwargs):
        ...
        partial_query.register_callback(self.bucket_callback('1-1'))
        p_1 = partial_query
        partial_query = partial_query ^ atom(match(switch = 5))
        partial_query.register_callback(self.bucket_callback('1-2'))
        p_1 += partial_query
        ...
        partial_query = partial_query ^ atom(match(switch = 5))
        partial_query.register_callback(self.bucket_callback('4-4'))
        p_4 += partial_query
        ...
        partial_query = partial_query ^ atom(match(switch = 5))
        partial_query.register_callback(self.bucket_callback('5-4'))
        p_5 += partial_query
