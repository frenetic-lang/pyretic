...
let
fun yyAction0 (strm, lastMatch : yymatch) = (yystrm := strm;   T.expr_0 )
fun yyAction1 (strm, lastMatch : yymatch) = (yystrm := strm;   T.expr_1 )
fun yyAction2 (strm, lastMatch : yymatch) = (yystrm := strm;   T.expr_2 )
fun yyAction3 (strm, lastMatch : yymatch) = (yystrm := strm;   T.expr_3 )
fun yyQ6 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
and yyQ7 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yystuck(lastMatch)
        | SOME(inp, strm') =>
            if inp = 0wx38
        ...
        | SOME(inp, strm') =>
            if inp = 0wx38
              ...
              then if inp = 0wx35
                  ...
                  then yyAction3(strm, yyNO_MATCH)
                  else yyQ6(strm', yyMATCH(strm, yyAction3, yyNO_MATCH))
            else if inp = 0wx41
...
and yyQ12 (strm, lastMatch : yymatch) = (case (yygetc(strm))
        ...
        | SOME(inp, strm') =>
            if inp = 0wx38
              ...
              then if inp = 0wx35
                  ...
                  then yyAction2(strm, yyNO_MATCH)
                  else yyQ6(strm', yyMATCH(strm, yyAction2, yyNO_MATCH))
            else if inp = 0wx41
      ...
      (* end case *))
and yyQ8 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yystuck(lastMatch)
        | SOME(inp, strm') =>
            if inp = 0wx32
...
and yyQ3 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
and yyQ4 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yystuck(lastMatch)
        | SOME(inp, strm') =>
            if inp = 0wx32
      ...
      (* end case *))
and yyQ5 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yystuck(lastMatch)
        | SOME(inp, strm') =>
            if inp = 0wx37
              then yyQ6(strm', lastMatch)
...
and yyQ21 (strm, lastMatch : yymatch) = (case (yygetc(strm))
      ...
      (* end case *))
and yyQ22 (strm, lastMatch : yymatch) = (case (yygetc(strm))
